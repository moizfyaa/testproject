                                ...
                                <tbody>
                                    <tr>
                                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <td><img src="/uploads/product/<?php echo e($product->image); ?>" height="100px";
                                                    width="100"></td>
                                            <td><?php echo e($product->description); ?></td>
                                            <td>
                                                <a type="button"
                                                    href="<?php echo e(route('update_product_view', $product->id)); ?>"
                                                    class="btn btn-lg btn-lg-rounded btn-outline-info m-2"><i
                                                        class="fa fa-edit"></i></a>
                                            </td>
                                            <td>
                                                <a type="button" href="<?php echo e(route('deleteproduct', $product->id)); ?>"
                                                    class="btn btn-lg btn-lg-rounded btn-outline-primary m-2"
...
<?php /**PATH C:\xampp\htdocs\MailFashion\resources\views/admin/showproduct.blade.php ENDPATH**/ ?>