                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><img src="/uploads/product/<?php echo e($blog->image); ?>" height="100px"; width="100"></td>
                                        <td><?php echo e($blog->blog_tags); ?></td>
                                        <td><?php echo e($blog->blog_content); ?></td>
                                        <td>
                                            <a type="button" href="<?php echo e(route('update_blog_view', $blog->id)); ?>" class="btn btn-lg btn-lg-rounded btn-outline-info m-2"><i class="fa fa-edit"></i></a>
                                        </td>
                                        <td>
                                            <a type="button" href="<?php echo e(route('deleteblog', $blog->id)); ?>"  class="btn btn-lg btn-lg-rounded btn-outline-danger m-2" onclick="return confirm('Are You Sure')"; ><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
...
</html><?php /**PATH C:\xampp\htdocs\MailFashion\resources\views/admin/blog/showblog.blade.php ENDPATH**/ ?>