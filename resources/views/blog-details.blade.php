            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-12">
                    <div class="blog__details__pic">
                        <img src="uploads/product/{{ $data->image }}" alt="">
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="blog__details__content">
                        ...
                        <div class="blog__details__btns">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    @if (isset($previous))
                                    <a href="{{ route('blog_detail_page', $previous->id) }}" class="blog__details__btns__item">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    @if (isset($next))
                                    <a href="{{ route('blog_detail_page', $next->id) }}" class="blog__details__btns__item blog__details__btns__item--next">
